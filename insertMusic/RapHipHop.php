<?php
    ...
    $RapHipHop = $api->requete("36058","");

    // Découpage du XML
    $xml_chaine = new SimpleXMLElement($RapHipHop);
    ...
    foreach ($xml_chaine->RESPONSE->ALBUM as $list_album) {
        ...
        //Si le morceaux n'existe pas on l'insert en base (vérification avec le grace note id)
